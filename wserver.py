    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/codedhumann">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/codedhumann"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>HI! You At The Start Line Bruh!", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>Coded Human Mirror Bot</h3>", content_type="text/html")
            return response
